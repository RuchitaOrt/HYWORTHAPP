...
//       BorderSide(color: CommonColors.background, width: 1.0);
//   final BorderSide focusedBorder =
//       BorderSide(color: CommonColors.blue, width: 1.0);
...
//   if (input.isEmpty || _selectedLatLng == null) return [];
...
//   //   location: places_api.Location(
//   //   lat: _selectedLatLng!.latitude, 
//   //  lng:  _selectedLatLng!.longitude
//   // ),
//     location: places_api.Location(lat:_selectedLatLng!.latitude,lng: _selectedLatLng!.longitude),
...
//                           ElevatedButton(
//                             onPressed: () async {
//                               final basicProvider = Provider.of<BasicFormProvider>(
//                                   context,
//                                   listen: false);
...
// const String googleApiKey = "AIzaSyBI08oetbPYPu-g8L2T7NkDrQ4kquAs0ak"; // Replace with your key
...
//   // Use autocomplete without restrictive types
//   final response = await places.autocomplete(
//     input,
//     sessionToken: sessionToken,
